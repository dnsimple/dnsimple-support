...
Comodo has been using SHA-2 hash algorithm by default since April 2014.

- Every wildcard certificate purchased from April 2014 and every certificate purchased from September 11th, 2014 is now hashed with SHA-2
