...
## The role of caching
When a new record is added, a DNS resolver may not see it immediately if it has recently queried the domain for that same record. Resolvers, which are used by browsers and applications, store DNS information in a cache to reduce network traffic and speed up lookups.
...
To learn more about how caching works and how to control it, read our [**Time-to-Live (TTL)**](https://support.dnsimple.com/articles/what-is-ttl/) article.
