...
1. Use the **account switcher** at the top of the page to select the appropriate account.
1. From the **Domain Names** list, click the domain you want to manage.
1. On the domain page, click the **DNS records icon** in the top-right corner of the screen (the small connected-nodes network icon next to the star icon). This opens the DNS Record Editor directly..
