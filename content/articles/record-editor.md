...
Any supported [DNS record](/articles/supported-dns-records/) type can be managed from the Record Editor, except [system records](/articles/system-records/). DNSimple provides two editor interfaces: the simple editor and the field-specific editor. To learn about the differences and when to use each, see [Understand DNSimple's Record Editors: Simple vs. Field-Specific](/articles/record-editor-simple-field/).
...
For step-by-step instructions and filtering options, see [How to View the Activity Log](/articles/activity-tracking/).
