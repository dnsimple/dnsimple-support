...
## Steps to set up SPF {#setup}

<div class="section-steps" markdown="1">
##### Set up an SPF record

1. Use the **account switcher** at the top right corner of the page to select the appropriate account.
1. From the <label>Domain Names</label> list, click the domain where you want to set up SPF.
1. On the domain page, click <label>DNS</label> at the top-right to open the <label>Record Editor</label>.
1. In the <label>Record Editor</label>, click <label>Add record</label>, and select **TXT** as the record type.
...
## Common SPF record examples {#examples}
...
> [!NOTE]
> This is a brief overview. For a comprehensive breakdown of SPF record format, all available mechanisms and modifiers, their specific syntax, and important validation rules (including the 10-DNS-lookup limit), see [SPF Record Syntax and Validation Reference](/articles/spf-syntax-validation-reference/).

## Managing SPF records {#managing}
