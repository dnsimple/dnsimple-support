...
Your domain must be delegated to [DNSimple name servers](/articles/dnsimple-nameservers/) for our [DNS hosting](/articles/dns-hosting/) to work. If it is not delegated to DNSimple's name servers, update the name servers to [point to DNSimple](/articles/pointing-domain-to-dnsimple/).
...
## Check name server propagation delay {#check-name-server-propagation-delay}
