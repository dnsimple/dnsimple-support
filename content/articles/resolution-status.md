...
## Resolution status in your DNSimple account {#resolution-status-in-your-dnsimple-account}
...
- To learn how to point a domain's name servers to DNSimple when it is registered with us, view [this article](/articles/delegating-dnsimple-registered/).
...
If you are experiencing issues with domain resolution, see [Troubleshoot Domain Resolution Issues](/articles/domain-resolution-issues/) or [Troubleshoot DNSimple Name Servers](/articles/troubleshoot-dnsimple-name-servers/) for comprehensive troubleshooting guidance.
