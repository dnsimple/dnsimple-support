...
## What information does a HINFO record contain? {#what-information-does-a-hinfo-record-contain}
...
## Why were HINFO records used? {#why-were-hinfo-records-used}
...
## Why are HINFO records less common now? {#why-are-hinfo-records-less-common-now}
...
## When might you encounter HINFO records? {#when-might-you-encounter-hinfo-records}
While not common in new deployments, you might still encounter HINFO records in the following scenarios:
- **Legacy systems**: Older networks or systems that have not been updated in a while might still have HINFO records configured.
