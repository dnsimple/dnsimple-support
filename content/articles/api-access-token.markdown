...
When you create a new token, you need to give it a name you can remember. After you've entered a name, click on <label>Generate token</label> to create the token.
