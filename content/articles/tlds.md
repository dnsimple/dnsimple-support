---
title: TLDs at DNSimple
excerpt: Learn about top-level domains supported by DNSimple, including registration, transfer, and per-TLD requirements.
meta: Comprehensive guide to top-level domains (TLDs) at DNSimple, including TLD basics, regulated TLDs, and documentation for each supported TLD.
categories:
- TLDs
---
...
DNSimple supports registration and transfer for many top-level domains (TLDs), including generic TLDs (e.g., .COM, .NET), country-code TLDs (e.g., .UK, .CA, .IO), and new gTLDs. This guide points you to TLD basics and to per-TLD documentation for requirements, pricing, and transfer rules.
...
- [.FI Domains](/articles/domains-fi/) - Requirements and procedures for .FI domain names.
- [.FR Domains](/articles/domains-fr/) - Requirements and procedures for .FR domain names.
- [.GAY Domains](/articles/domains-gay/) - Requirements and procedures for .GAY domain names.
- [.GEN.NZ Domains](/articles/domains-gen-nz/) - Requirements and procedures for .GEN.NZ domain names.
- [.INSURANCE Domains](/articles/domains-insurance/) - Requirements and procedures for the regulated .INSURANCE TLD.
- [.IO Domains](/articles/domains-io/) - Open to individuals and organizations worldwide; popular in tech and startups.
- [.IS Domains](/articles/domains-is/) - Requirements and procedures for .IS domain names.
...
- [.ORG.NZ Domains](/articles/domains-org-nz/) - Requirements and procedures for .ORG.NZ domain names.
- [.ORG.UK Domains](/articles/domains-org-uk/) - Requirements and procedures for .ORG.UK; .UK transfer and ownership rules apply.
