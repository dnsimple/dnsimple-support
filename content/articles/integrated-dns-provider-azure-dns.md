...
- **Import integrated zones**: When you connect Azure DNS to your DNSimple account, you can [select](/articles/integrated-dns-providers##managing-integrated-zone-selection) which zones hosted on Azure to import into DNSimple and be listed on the [Domain Names](/articles/managing-integrated-zones) page.
