...
1. Click on the **Import** link inside the zones card located on the right-hand panel.


    ![Import zone link](/files/import-zone.png)

1.  Paste the content from the zone file into the text area, and click **Import Zone**.
