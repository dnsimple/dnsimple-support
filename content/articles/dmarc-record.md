...
## What is a DMARC record? {#what-is}
...
## How DMARC works: building on SPF and DKIM {#how-it-works}
...
### Authentication and alignment {#alignment}
...
### Reporting and feedback {#reporting}
...
For step-by-step instructions on how to add a DMARC record to your DNSimple zone, including guidance on the required `_dmarc` subdomain and common policy tags, refer to our dedicated how-to guide: [Setting Up DMARC](/articles/set-up-dmarc/).
