...
For what happens when payment stops, see [What Happens if I Stop Paying for My DNSimple Subscription?](/articles/what-happens-if-i-stop-paying/). If non-payment caused the suspension, you may be able to [reactivate your subscription](/articles/reactivate-subscription/) after resolving billing.

For failed invoices, card updates, and renewal retries, see [Troubleshoot Billing and Payment Failures](/articles/troubleshoot-billing-and-payment-failures/).
...
If your email address is under a domain in the suspended account and no longer works, contact us from an alternate email address. Include the [user email](/articles/changing-email/#changing-the-user-email) or [notification email](/articles/changing-email/#setting-or-changing-the-notification-email) for the account in your message. We may ask for additional information to verify your identity.
