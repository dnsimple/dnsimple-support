...
## Adding members to an account {#adding-members}
...
1. Enter the email address of the person you want to invite. They can already have a DNSimple user, or create one when they accept. Choose their access level when you send the invitation. See [What is Domain Access Control?](/articles/what-is-domain-access-control/).
...
## Removing members from an account {#removing-members}
...
## Managing member access {#managing-access}
