...
To register a domain to your account, follow the steps in [Register a Domain](/articles/registering-domain/).
...
Before you transfer a domain from another registrar, make sure to read our article on [how to prepare to transfer your domain](/articles/before-transferring-domain/).

Once your domain is ready to go, you can [transfer](/articles/domain-transfer/) it to DNSimple. We also help you [transfer without downtime](https://dnsimple.com/how-to-transfer-a-domain-without-downtime), ensuring your customers have continued access to your site.

**Transferring DNS management**

You also have the option to keep the domain registration at your current registrar and transfer only the DNS management to us — [this article](/articles/delegating-dnsimple-hosted/) shows you how.
