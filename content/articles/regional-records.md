...
By default, if you do not specify any regions for a record, it is made available across all of DNSimple's PoPs. You have the option to pick from our <%= POPS.count %> points of presence:
