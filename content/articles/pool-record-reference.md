...
## POOL record format {#pool-record-format}
...
**Random selection**: When a DNS resolver queries a domain with a POOL record, DNSimple's name servers randomly select one of the target hostnames you have defined within your POOL record.
