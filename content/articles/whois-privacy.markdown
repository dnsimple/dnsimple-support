...
1.  To enable the WHOIS Privacy service, click on the <label>Enable WHOIS Privacy on</label> link.
...
1.  To disable the WHOIS Privacy service click on the <label>Disable WHOIS Privacy</label> link.
