---
title: Understand DNSimple's Record Editors Simple vs. Field-Specific
...
## The simple editor: flexible for common records and pasting {#the-simple-editor-flexible-for-common-records-and-pasting}
...
## The record fields editor: guided input for complex records {#the-record-fields-editor-guided-input-for-complex-records}
...
- **Enhanced error messages**: By having discrete fields, the editor can provide more specific and helpful validation messages in real-time, reducing errors during configuration. For example, it might warn you if a port number is out of range or if a hostname is not a valid format for a specific field.
- **Ensuring correct formatting**: It ensures that each part of the record is entered in the correct format, even if you are not intimately familiar with the RFC specifications.
  
## Switching between editors {#switching-between-editors}
...
## Why DNSimple offers both editors {#why-dnsimple-offers-both-editors}
