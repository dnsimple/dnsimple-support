...
## What is SuperLock? {#what-is-superlock}
...
## Why SuperLock is needed {#why-superlock-is-needed}
...
## Enabling SuperLock {#enabling-superlock}
...
## Disabling SuperLock {#disabling-superlock}

If you want to transfer a domain that has SuperLock enabled, you will need to disable SuperLock before you can proceed. Disabling SuperLock requires a quorum of 2 users in the account to proceed.
...
If you have any questions about DNSimple SuperLock or need assistance protecting your domains, just [contact support](https://dnsimple.com/feedback), and we will be happy to help.
