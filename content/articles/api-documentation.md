...
This site includes details about all of our API endpoints as well as libraries and tools that have been built on top of the library. The [DNSimple CLI](/articles/dnsimple-cli/) provides command-line access to the API for managing domains, DNS records, certificates, and more from your terminal.
