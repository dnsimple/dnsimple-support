...
Two-factor authentication helps mitigate the risk of unauthorized access to your accounts and increases the security of your data. If somebody is able to steal your password, they will also need to get access to your authenticator app (generally installed on your mobile device) to login.
...
When you enable two-factor authentication on a user, all currently logged in devices will be logged out.
...
1.  Click <label>Disable</label> to confirm and disable two-factor authentication for the user.
</div>
...
When you enable two-factor authentication, a recovery code is created as a safeguard. The recovery code is used to disable two-factor authentication for a user when you can't generate a token with the authenticator app, for example because you lost the device where the authenticator was installed.
