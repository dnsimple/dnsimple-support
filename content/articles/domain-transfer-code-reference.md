...
## Transfer code overview {#transfer-code-overview}
...
## Transfer code terminology {#transfer-code-terminology}
...
## Transfer code format {#transfer-code-format}
...
## When transfer codes are required {#when-transfer-codes-are-required}
...
## Obtaining a transfer code {#obtaining-a-transfer-code}
...
**Spam folder:** If you do not receive the transfer code, check your spam folder. Consider adding these email addresses to your trusted contacts to ensure optimal delivery.

## Transfer code security {#transfer-code-security}

**Confidentiality:** Transfer codes are sensitive and should be kept confidential. Only share the transfer code with the registrar where you are transferring the domain.
...
**Resending codes:** If you requested a transfer code and have not received it within the expected time frame, you can request it again. However, avoid requesting it multiple times in quick succession, as this may delay delivery.

## Using a transfer code {#using-a-transfer-code}

**During transfer initiation:** When initiating a domain transfer, you will be prompted to enter the transfer code. Enter the code exactly as provided, including any uppercase or lowercase letters and special characters.
...
## Troubleshooting transfer codes {#troubleshooting-transfer-codes}

**Code not received:** If you have not received a transfer code within the expected time frame:
