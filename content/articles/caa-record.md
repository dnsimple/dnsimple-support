...
---
## What is a CAA record? {#what-is-a-caa-record}
...
A CAA record acts like a whitelist for CAs. It is a powerful tool to prevent mis-issuance of certificates, which could otherwise be exploited for malicious activities like phishing or man-in-the-middle attacks.

## How CAA records control certificate issuance {#how-caa-records-control-certificate-issuance}
...
## Why CAA records are important for your security {#why-caa-records-are-important-for-your-security}
...
## Setting up and understanding CAA record details {#setting-up-and-understanding-caa-record-details}
For step-by-step instructions on how to add a CAA record to your DNSimple zone, please refer to our dedicated How-To Guide: [Manage CAA Records](/articles/manage-caa-record/).
