# SSL Certificates Documentation Revamp – Architecture Proposal
...
- **Only 3 files renamed** (Standard → Sectigo terminology change):
...
- **All other file slugs remain unchanged** (DNSimple doesn't use "how-to-" prefixes)
...
- **File naming:** Only rename files with "Standard" terminology. Keep all other slugs unchanged.
